...
import {
    ...
    TouchableOpacity, BackHandler, Alert, Animated, ImageBackground
} from 'react-native';
        ...
        (async () => {
            ...
            subscriber = await Location.watchPositionAsync(
                ...
                async (loc) => {
                    ...
                    setCurrentAddress(`${address[0]?.name || ''}, ${address[0]?.street || ''}`);
                }
            );
        })();
...
const styles = StyleSheet.create({
    ...
    walletCard: { position: 'absolute', top: 100, right: 20, zIndex: 999, backgroundColor: '#fff', borderRadius: 14, paddingVertical: 10, paddingHorizontal: 16, elevation: 5, alignItems: 'center' },
    walletTitle: { fontSize: 12, color: '#666', fontWeight: '600' },
    walletAmount: { fontSize: 18, color: '#2a3f8f', fontWeight: '700', marginTop: 2 },

    statCard: { position: 'absolute', bottom: 100, left: 20, backgroundColor: '#fff', borderRadius: 12, paddingVertical: 10, paddingHorizontal: 18, elevation: 4, alignItems: 'center' },
    statVal: { fontSize: 22, fontWeight: '700', color: '#4338ca' },
    statLbl: { fontSize: 11, color: '#888', marginTop: 2 },

    // ✅ Test button style
    testBtn: { position: 'absolute', bottom: 30, alignSelf: 'center', backgroundColor: '#1270B8', paddingVertical: 12, paddingHorizontal: 24, borderRadius: 25, elevation: 6 },
    ...
    btnAccept: { flex: 1, backgroundColor: '#1270B8', borderRadius: 10, paddingVertical: 11, alignItems: 'center' },
